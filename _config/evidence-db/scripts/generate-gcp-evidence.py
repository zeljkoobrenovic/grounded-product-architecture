...
DEFAULT_INPUT = SCRIPT_DIR.parent.parent / "data" / "gcp" / "data" / "json" / "projects.json"
DEFAULT_OUTPUT = SCRIPT_DIR / "evidence-db" / "gcp.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", type=Path, default=DEFAULT_INPUT, help="Path to GCP projects.json")
