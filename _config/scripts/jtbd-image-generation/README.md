...
python3 _config/scripts/jtbd-image-generation/generate_jtbd_images_openai_images_api.py --dry-run
python3 _config/scripts/jtbd-image-generation/generate_jtbd_images_openai_images_api.py --domain nutrition --limit 4
