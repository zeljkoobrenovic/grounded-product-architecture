...
codex exec "Review $1 using the spda-product-domain-review skill."
...
codex exec "Update review of $1 based on recent changes using the spda-product-domain-review skill. Expand review with the in-depth review using spda-product-bricks-review skil."
...
codex exec "Update review of $1 based on recent changes. Expand review with the in-depth review spda-teams-review skil."
