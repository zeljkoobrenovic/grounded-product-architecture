...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input", type=Path, required=True, help="Path to raw repositories.json")
    parser.add_argument("--output", type=Path, required=True, help="Path to generated repositories.json")
    parser.add_argument(
...
def build_fragment(repository: dict, sokrates_report_url_prefix: str) -> dict:
    ...
    _, repo_name = split_repo_name(full_name)

    return {
        "id": full_name or repo_name,
        "type": "source-code-repository-analysis",
        "icon": "evidence-source-code-repository-analysis.png",
