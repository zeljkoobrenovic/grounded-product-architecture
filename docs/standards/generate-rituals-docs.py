...
config_root = os.path.join(script_dir, '../../_config/standards/rituals')
templates_root = os.path.join(script_dir, '../../_templates/rituals')
docs_folder = os.path.join(script_dir, 'rituals')
