...
templates_root = '../../_templates/product/customers/'
...
def create_landing_pages(customers, docs_folder):
...
for domain in config['domains']:
    ...
    customers_file_path = domains_root + domain_id + '/product/customers.json'
    ...
    create_landing_pages(customers, docs_folder)
